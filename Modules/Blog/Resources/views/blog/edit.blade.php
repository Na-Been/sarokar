...
@section('content')
    ...
    <!-- END: Top Bar -->
        ...
        <div class="col-span-12">
            {!! Form::model($blog,['method'=>'PUT','route'=>['blog.update',$blog->id], 'enctype'=>'multipart/form-data']) !!}
                ...
                <div class="box">
                    <div class="grid grid-cols-12 mt-5">
                        ...
                        <div
                            ...
                            {!! Form::select('status', ['1' => 'Published', '0' => 'Inactive'], null, ['class' => 'input w-full border flex-1']) !!}
