                    ...
                    <div class="grid grid-cols-12 mt-5">
                        <div
                            ...
                            <div
                                ...
                                <div class="input-group">
                                   <span class="input-group-btn">
                                     <a id="lfm3" data-input="thumbnail2" data-preview="holder2" class="btn btn-primary" style="cursor: pointer">
                        ...
                        <div class="intro-y col-span-12 sm:col-span-3 p-2">
                            <div
                                class="intro-y col-span-12 sm:col-span-7  p-2 {{($errors->has('category_id')) ? 'has-error':''}} ">
