...
@section('title','Edit News Sub Category')
@section('content')
    <div class="content">
        <!-- BEGIN: Top Bar -->
    ...
    <!-- END: Top Bar -->
        ...
        <div class="col-span-12">
            {!! Form::model($newsSubCategory,['method'=>'PUT','route'=>['news-sub-category.update',$newsSubCategory->id], 'enctype'=>'multipart/form-data']) !!}
                ...
                <div class="box">
                    <div class="grid grid-cols-12 mt-5">
                        <div
                            ...
                            {!! Form::select('category_id',$categories->pluck('title','id'),$newsSubCategory->category->id,['class' => 'input w-full border flex-1','placeholder'=>'Choose Category Title']) !!}
