...
@section('title','Creat News Category')
@section('content')
    <div class="content">
        <!-- BEGIN: Top Bar -->
    ...
    <!-- END: Top Bar -->
        ...
        <div class="col-span-12">
            {!! Form::open(['method'=>'post','route'=>'news-category.store', 'enctype'=>'multipart/form-data']) !!}
            <div class="col-span-12 lg:col-span-6">
                <div class="box">
                    <div class="grid grid-cols-12 mt-5">
                        <div
                            class="intro-y col-span-6 sm:col-span-6  p-5 {{($errors->has('title')) ? 'has-error':''}} ">
                            <div class="mb-2 font-medium">Category Name<span class="text-theme-6">*</span></div>
                            {!! Form::text('title',null,['class' => 'input w-full border flex-1','placeholder'=>'Enter Category Name']) !!}
