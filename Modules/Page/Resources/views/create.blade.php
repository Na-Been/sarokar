...
@section('content')
    ...
    <!-- END: Top Bar -->
        ...
        <div class="col-span-12">
            {!! Form::open(['method'=>'post','url'=>'backend/page', 'enctype'=>'multipart/form-data']) !!}
            <div class="col-span-12 lg:col-span-6">
                <div class="box">
                    <div class="grid grid-cols-12 mt-5">
                        <div
                            class="intro-y col-span-12 sm:col-span-6  p-5 {{($errors->has('parent_id')) ? 'has-error':''}} ">
                            <div class="mb-2 font-medium">Parent Page <span class="text-theme-6">*</span></div>
                            {!! Form::select('parent_id',$pages->pluck('title','id'), null, ['class' => 'input w-full border flex-1','placeholder'=>'-- Select Parent Page --','required'=>'required' ]) !!}
                            {!! $errors->first('parent_id', '<div class="pristine-error text-theme-6 mt-2">:message</div>') !!}
                        </div>
                        ...
                        <div
                            ...
                            {!! Form::text('title',null,['class' => 'input w-full border flex-1','placeholder'=>'Enter Page Title','required'=>'required' ]) !!}
                    ...
                    <div class="p-5" id="standard-editor">
                        ...
                        {!! Form::textarea('description',null,['class'=>'editor','placeholder' => 'Page Description','required'=>'required' ]) !!}
                    </div>
                    <div class="grid grid-cols-12 mt-5">
                        <div
                            ...
                            {!! Form::number('order', null, ['class' => 'input w-full border flex-1','required'=>'required']) !!}
                        ...
                        <div
                            ...
                            <div class="mb-2 font-mediun">Status</div>
